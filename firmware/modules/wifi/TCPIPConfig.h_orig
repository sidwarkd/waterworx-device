 ...
 */
#define MY_DEFAULT_HOST_NAME			"EMBDFUN"
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(1869ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		{
			{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_PIC_RAM, 125, 500},
			//{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 20, 20},
			{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 200, 500},
			//{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 200, 500},
			//{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 200, 500},
